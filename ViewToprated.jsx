...
const ViewToprated = () => {
  ...
  return (
    <>
      ...
      >
        <div className="bg-gray-900 bg-opacity-70 h-full md:w-[40%] w-full rounded-md p-3">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-[30%] w-full h-[200px] rounded-md">
              <img
            ...
            <div className="pl-3 w-full md:w-[70%] text-left">
              <h1 className="text-2xl md:text-3xl font-bold my-2">{movie.title}</h1>
              <p className="text-xl md:text-3xl mb-3">Rating: {movie.vote_average}</p>
          ...
          <div className="text-left">
            <h2 className="text-xl md:text-2xl mt-4 mb-2">Overview</h2>
            <p>{movie.overview}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-900 bg-opacity-80 p-3 w-full">
        ...
        <div className="flex flex-wrap justify-center">
          {cast.slice(0, 10).map((actor) => (
            <div key={actor.cast_id} className="w-full md:w-[15%] m-2 text-center shadow-[0_0_29px_0_rgba(0,0,0,0.3)]">
              <img
                src={`https://image.tmdb.org/t/p/w200${actor.profile_path}`}
                alt={actor.name}
                className="h-[300px] w-[200px] md:w-[300px] object-cover"
              />
